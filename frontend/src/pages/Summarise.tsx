...
// // Import the Markdown Editor and its styles
// import MDEditor from '@uiw/react-md-editor';
// import '@uiw/react-md-editor/markdown-editor.css';
// import '@uiw/react-markdown-preview/markdown.css'; 
// // If you're using remark-gfm or remark-breaks, import them here
// // import remarkGfm from 'remark-gfm';
// // import remarkBreaks from 'remark-breaks';


// const SummarizePage: React.FC = () => {
//   // State variables - all correctly initialized and will be used below
//   const [inputText, setInputText] = useState<string>('');
//   const [displayedText, setDisplayedText] = useState<string>('');
//   const [fileName, setFileName] = useState<string | null>(null);
//   const [summaryOutput, setSummaryOutput] = useState<string>(''); // Holds the editable Markdown summary
//   const [loading, setLoading] = useState<boolean>(false);
//   const [isDragOver, setIsDragOver] = useState<boolean>(false); 

//   // Ref for file input (still used)
//   const fileInputRef = useRef<HTMLInputElement>(null);
//   // outputRef is no longer needed as MDEditor handles its own internal DOM structure
//   // If you had a specific use for outputRef outside of direct rendering, re-evaluate its need.
...
//       const result = await response.json();
//       setSummaryOutput(result.summary); // Set the Markdown string
//       toast.success("Summary generated successfully!");
...
//               id="transcription-text"
//               placeholder="Paste your conversation transcription here..."
//               value={displayedText} // `displayedText` is used here
//               onChange={handleTextareaChange}
//               rows={15}
//               className="w-full resize-y min-h-[200px]"
//             />
...
//             {/* Summarize Button */}
//             <Button onClick={handleSummarize} disabled={loading} className="mt-4 w-full"> {/* `loading` is used here */}
//               {loading ? "Summarizing..." : "Summarize"}
//             </Button>
//           </CardContent>
//         </Card>

//         {/* --- Output Section Card (UPDATED) --- */}
//         <Card className="flex-1 min-w-[300px]">
//           <CardHeader>
//             <CardTitle>Templated Summary</CardTitle>
//           </CardHeader>
//           <CardContent>
//             {/* Replace the div with MDEditor */}
//             {summaryOutput ? ( // `summaryOutput` is used here
//               <MDEditor
//                 value={summaryOutput} // `summaryOutput` is used here
//                 onChange={(val) => setSummaryOutput(val || '')} // `setSummaryOutput` is used here
//                 height={400} // Example fixed height
//                 // remarkPlugins={[remarkGfm, remarkBreaks]} // Add if you need these and imported them
//               />
//             ) : (
//               <p className='text-gray-500 min-h-[400px] flex items-center justify-center'>
