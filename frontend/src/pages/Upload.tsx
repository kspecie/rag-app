...
import { CollectionManager } from "../components/ui/collection-manager"; // Import the new component
...
const UploadPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-[calc(100vh-theme(spacing.24))] py-8 px-4 max-w-4xl mx-auto">
      ...
      <hr className="my-12 w-full max-w-4xl border-t border-gray-200" />
      
      <h2 className="text-2xl font-bold mb-6">Manage Knowledge Collections</h2>
      <p className="text-gray-600 mb-8 text-center">
        Control and update the specific datasets used to answer your questions.
      </p>
      
      {/* New Collection Manager Component */}
      <CollectionManager />
