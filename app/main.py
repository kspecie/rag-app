...
API_KEY = os.getenv("API_KEY", "your-super-secret-default-key")
if API_KEY == "your-super-secret-default-key":
...
app.include_router(collections_router, prefix="/api", dependencies=[Depends(get_api_key)])
