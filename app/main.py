...
# Import your routers
from app.api import documents, summaries # Assuming __init__.py in app/api exports these

# Initialize FastAPI app
app = FastAPI(
    title="Medical Conversation RAG API",
    description="API for ingesting medical conversation documents and generating clinical summaries.",
    version="1.0.0"
)
...
# You can add a root endpoint if you want a basic health check
@app.get("/")
async def root():
    return {"message": "Medical Conversation RAG API is running!"}
